    ...
    <form method="POST" class="grid grid-cols-1 gap-6">
        ...
        <label class="block">
            ...
            <select name="country" class="block w-full mt-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                ...
                <option value="Canada" <?php if (isset($_POST['country'])) {
                                            echo $oldFormData['country'] === 'Canada' ? 'selected' : '';
                                        } ?>>Canada</option>
                <option value="Mexico" <?php if (isset($_POST['country'])) {
        ...
        <label class="block">
            ...
            <input value="<?php echo e($oldFormData['url'] ?? ''); ?>" name="socialMediaUrl" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="" />
